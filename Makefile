...
install:
	...
	cp -f bin/mw bin/mailsync bin/convert-multipart $(DESTDIR)$(PREFIX)/bin/
...
uninstall:
	rm -f $(DESTDIR)$(PREFIX)/bin/mw $(DESTDIR)$(PREFIX)/bin/mailsync $(DESTDIR)$(PREFIX)/bin/convert-multipart $(DESTDIR)$(PREFIX)/lib/mutt-wizard/openfile
